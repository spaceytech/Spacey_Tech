...
<div class="email__background" style="padding: 10px;">
  ...
  <div class="email__container" style="margin: 0 auto;max-width: 700px;">
    ...
    <a href="http://localhost:3002/signin" class="button" style="text-decoration: none;"><div style="padding: 20px 25px;background: #00bc87;border: #00bc87;color: white;font-size: 15px;border-radius: 5px;font-family: &quot;Ubuntu&quot;, sans-serif;margin: 0 auto;text-align: center;width: 40%;">Confirm your email</div></a>
    ...
    <div class="email__container--footer">
      <ul style="width: 100%;list-style: none;margin: 0;padding: 0;font-family: &quot;Lato&quot;, sans-serif;text-align: center;">
        <li style="display: inline-block;margin-right: 3px;border-right: 1px solid #000;padding-right: 10px;color: #00bc87;font-weight: 700;">spaceytech.com</li>
        <li style="display: inline-block;margin-right: 3px;border-right: 1px solid #000;padding-right: 10px;color: #00bc87;font-weight: 700;">Privacy policy</li>
