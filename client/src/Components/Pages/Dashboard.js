          ...
          <div className="dashboard__container">
            ...
            <div className="dashboard__container--details">
              <div className="dashboard__container--details__upload">
                ...
                <p>Add photo</p>
                <p>
                  Please upload a photo of yourself that clearly conveys who you
                  are. Having a friendly, professional photo inspires confidence
                  and will increase your likelihood of being hired
                </p>
              </div>
              <div className="dashboard__container--details__inputs">
                <h3>Registered address</h3>
                <p>
                  This information will be used to officially verify your
                  identity. Please give your full address including flat/house
              ...
              <div className="dashboard__container--details__vehicle">
                <h3>
                  Do you have access to a vehicle that you can reliably use for
                  tasks?
                </h3>
                <label>
                  <input
                ...
                <label>
                  ...
                  <p>
                    For transporting multiple large-sized items in a single
                    trip.
                    <br />
                ...
                <label>
                  ...
                  <h4>Transit Vans</h4>
                  <p>
                    For transporting multiple medium-sized items and large
                    single items in one or multiple trips.
                    <br />
                    <b>Examples</b>: Items from a studio flat or small storage
                    unit, or one king-size mattress.
                  </p>
                </label>
              </div>
              ...
              <Link to="/dashboard/categories" className="button">
