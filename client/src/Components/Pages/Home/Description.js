  ...
  return (
    <main className="home__description">
      ...
      <div className="home__description--detail detail--2">
        ...
        <h2>Get matched</h2>
        <p>
          Select from a list of qualified and fully vetted Taskers for the job.
          Choose Taskers by their hourly rate and start chatting with them right
          in the app.
        </p>
      </div>
      <div className="home__description--detail detail--3">
        ...
        <p>
          ...
          task is complete, payment will happen seamlessly and securely through
          the app.
        </p>
      </div>
    </main>
